...
draw_text_transformed(x + border_size + 2 * offset, y + sprite_height/2 - 8, loaded ? name : "", 0.4, 0.4, 0);
draw_set_font(secondaryFont);
draw_set_color(loaded and online ? #36ff4d : #a6a6a6);
draw_set_alpha(0.8)
draw_text_transformed(x + border_size + 2 * offset, y + sprite_height/2 + 8, loaded and online ? "ONLINE" : "OFFLINE", 0.2, 0.2, 0);
