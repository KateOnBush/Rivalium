...
/// @param {Bool} enabled Defines whether the effect starts active or not.
/// @param {Array<Real>} position Sun position. An array with the normalized values (0 to 1), in this format: [x, y].
/// @param {Real} threshold Set the level of brightness to filter out pixels under this level. 0 above; 0 means full brightness.
...
/// @param {Pointer.Texture} noise_tex The noise texture, used for rays.
...
/// @param {Real} white_amount The How close Bloom will be to white in saturated light
/// @param {Bool} dirt_enable Defines whether to use dirt textures.
/// @param {Pointer.Texture} dirt_texture The texture id used for the Dirt Lens. Use sprite_get_texture() or surface_get_texture().
...
/// @param {Real} downscale Sets the downscale of the Bloom, this changes the performance. 1 is full resolution.
...
function FX_SlowMotion(enabled, intensity=0.85, iterations=10) constructor {
...
/// @param {Bool} enabled Defines whether the effect starts active or not.
/// @param {Real} value How much the grayscale is blended with the original image. 0 to 1.
...
/// @param {Pointer.Texture} prisma_lut_tex The spectral LUT texture, used to define the spectral colors.
/// Texture should be 8x3, with RGB channels horizontally. Use sprite_get_texture() or surface_get_texture().
...
/// @param {Pointer.Texture} noise_tex The noise texture to be used as mist/fog.
/// @param {Array<Real>} offset Position offset. Use the camera position. An array with absolute values, in this format: [cam_x, cam_y].
...
/// @param {Real} mask_scale Defines the radial mask scale. 0 to 3 recommended.
/// @param {Real} mask_smoothness Defines the mask border smoothness. 0 to 1.
/// @param {Pointer.Texture} noise_tex The noise texture to be used by the effect.
...
/// @param {Pointer.Texture} [bayer_texture] Bayer texture to be used by dithering. This is a small square texture.
...
/// @param {id.Texture} [noise_tex] Noise texture. Use sprite_get_texture() or surface_get_texture().
